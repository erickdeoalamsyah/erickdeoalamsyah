...
//               }}
//               className="absolute inset-0 hidden md:block duration-200 bg-gradient-to-b from-gray-300 to-gray-500  -z-10 clip-path"
//             />
...
//                 <p
//                   key={framework.id}
//                   className="text-gray-200 transition-colors duration-500 md:group-hover:text-black"
//                 >
//                   {framework.name}
//                 </p>
//               ))}
//             </div>
//             <div className="text-xs px-10 text-gray-300 md:group-hover:text-bla md:group-hover:px-12 uppercase">
//               <p >
//                 {project.description}
//               </p>
//             </div>
          ...
          >
            ...
            <div className="flex px-10 text-xs leading-loose uppercase transition-all duration-500 md:text-sm gap-x-5 md:group-hover:px-12">
              {project.frameworks.map((fw, i) => (
                <p
                  key={`${project.id ?? "p"}-fw-${i}`}  // <- SELALU unik dalam satu list
                  className="text-gray-200 transition-colors duration-500 md:group-hover:text-black"
                >
                  {fw.name}
                </p>
            ...
            {/* description */}
            <div className="text-xs font-semibold px-10 text-gray-300 md:group-hover:text-black md:group-hover:px-12 uppercase">
